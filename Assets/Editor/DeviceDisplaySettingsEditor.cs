...
public class DeviceDisplaySettingsEditor : Editor
{
    ...
    private ReorderableList _customInputContextIconList;
    ...
    {
        _customInputContextIconList = new ReorderableList(serializedObject, serializedObject.FindProperty("customContextIcons"), true, true, true, true)
        {
        ...
        _customInputContextIconList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
        {
            SerializedProperty element = _customInputContextIconList.serializedProperty.GetArrayElementAtIndex(index);
    ...
    {
        _deviceDisplaySettings = (DeviceDisplaySettings)target;
        ...
        if (_deviceDisplaySettings.deviceHasContextIcons == true)
        {
            DrawSpaceGUI(3);
            ...
            _customInputContextIconList.DoLayoutList();
        }
