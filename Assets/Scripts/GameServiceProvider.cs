...
public class GameServiceProvider : MonoBehaviour, IInstaller
{
    ...
    [SerializeField] private GameObject _optionsManagerPrefab;
    ...
    public void InstallBindings(ContainerBuilder builder)
    {
        ...
        GameObject optionsManagerInstance = Instantiate(_optionsManagerPrefab);
        ...
        builder.AddSingleton(optionsManagerInstance.GetComponent<OptionsManager>(), typeof(OptionsManager));
        ...
        GameObjectInjector.InjectRecursive(optionsManagerInstance, container);
